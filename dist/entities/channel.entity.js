...
const users_muted_entity_1 = require("./users_muted.entity");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => index_1.User, (user) => user.channels, { cascade: true, nullable: true }),
...
__decorate([
    (0, typeorm_1.OneToMany)(() => users_muted_entity_1.default, (userMuted) => userMuted.channel),
    __metadata("design:type", Array)
], Channel.prototype, "usersMuted", void 0);
__decorate([
    (0, typeorm_1.ManyToMany)(() => index_1.User, user => user.forbiddenChannels),
    (0, typeorm_1.JoinTable)(),
    __metadata("design:type", Array)
], Channel.prototype, "blacklistedUsers", void 0);
__decorate([
    (0, typeorm_1.ManyToMany)(() => index_1.User, user => user.channelInvites),
    (0, typeorm_1.JoinTable)(),
    __metadata("design:type", Array)
], Channel.prototype, "invitedUsers", void 0);
Channel = __decorate([
    (0, typeorm_1.Entity)()
], Channel);
